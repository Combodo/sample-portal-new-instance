 ...
 */
class SamplePortalUrlMaker implements iDBObjectURLMaker
{
...
// Note : This needs to be changed in order to be unique among the portal instances
DBObject::RegisterURLMakerClass('sample-portal', 'SamplePortalUrlMaker');
